import doctor5 from "../../../../assets/doctorImage/doctor-5.jpg";
import doctor6 from "../../../../assets/doctorImage/doctor-6.jpg";
const OurService = () => {
  return (
    <div>
      <div className="card  lg:card-side  shadow-xl">
        ...
        <div className="card-body ml-20">
          ...
          <p>
            Sed ut perspiciatis unde omnis iste natus error sit voluptatem <br/> accusantium doloremque laudantium, totam rem aperiam, <br/> eaque ipsa quae ab illo inve ntore veritatis et quasi  architecto beatae <br/> vitae dicta sunt explicabo.
          </p>
